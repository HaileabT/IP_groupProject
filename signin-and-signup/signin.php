...
<body>
    ...
    <main>
        <div class="main-login-container">
            ...
            <form action="ind.php" method="POST" class="all-login-form-container" id="all-form-group">
                <div class="login-email-container container">
                    <label for="email">Email</label><br />
                    <div class="login-email-message-container icon-cont">
                        <input type="email" name="email" id="email" form="all-form-group" class="input" required pattern="^(.+)@(.+)$" />
                ...
                <div class="login-password-container container">
                    ...
                    <div class="login-pass-message-container icon-cont">
                        <input type="password" name="password" id="password" form="all-form-group" autocomplete="password" class="input" minlength="8" custommaxlength="12" class="input" required />
                        <span class="success-icon"><i class="fa-solid fa-circle-check"></i></span>
                        <span class="fail-icon"><i class="fa-solid fa-circle-exclamation"></i></span>
                    </div>
                    <div class="Error-message"></div>
