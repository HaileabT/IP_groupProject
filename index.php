      ...
      <nav id="primary-nav">
        <ul type="none" class="nav-ul header-links-nav-ul">
          <li id="head-home-list">
            <a href="index.html" id="head-home-link" class="link current">Home</a>
          </li>
  ...
  <main id="page-main">
    ...
    <section id="accomodations">
      ...
      <article>
        ...
        <div class="room-img-container-f">
          <img width="100%" src="assets/images/executive-suite.jpg" alt="Executive Suite Bedroom" loading="lazy"
            title="Executive Suite Room 406" />
        </div>
        <div class="room-img-container-l">
          <img width="100%" src="assets/images/executive-suite2.jpg" alt="Executive Suite Bedroom" loading="lazy"
            title="Executive Suite Room 407" />
        </div>
      </article>
      <article class="in-room-services-art">
        ...
        <p>
          ...
          space to make your stay at NightStar Hotel truly exceptiona
        </p>
      </article>
    </section>
