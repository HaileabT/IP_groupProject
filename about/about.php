...
<body>
  <header id="main-header">
    ...
    <div class="motto-container">
      ...
      <a href="booking/booking.html" class="call-to-action goto-booking">Book Now <i class="fa-solid fa-square-arrow-up-right"></i></a>
    </div>
  </header>
    ...
    <div class="team-container">
      ...
      <div class="team-box-holder">
        <div class="team1-leader-container team-box">
          <img src="assets/images/nesredin.jpg" alt="Human Resources Team Leader's Photo" class="team-leader-photo" />
        ...
        <div class="team2-leader-container team-box">
          <img src="assets/images/dagmawi.jpg" alt="Event Planning Team Leader's Photo" class="team-leader-photo" />
